      ...
      <div className="list__div-filter no-scrollbar w-[220px] overflow-y-scroll py-3.5">
        ...
        <details className="border-b border-gray-100 group" open>
          ...
          <ul className="list__ul-filter-category pl-1 text-[14px]">
            <li className="flex items-center pt-2 pb-4">
              <input type="checkbox" id="면" name="면" defaultValue="면" className="appearance-none peer" />
              <label htmlFor="면" className="w-6 h-6 mr-2 bg-input__button bg-check--no peer-checked:bg-check--yes" />
              <label htmlFor="면">면</label>
              <span className="pl-2 text-gray-300 align-middle text-p-sm">4</span>
            </li>
            <li className="flex items-center pt-2 pb-4">
              <input type="checkbox" id="채소" name="채소" defaultValue="채소" className="appearance-none peer" />
              <label htmlFor="채소" className="w-6 h-6 mr-2 bg-input__button bg-check--no peer-checked:bg-check--yes" />
        ...
        <details className="border-b border-gray-100 group" open>
          ...
          <ul className="list__ul-filter-brand pl-1 text-[14px]">
            <li className="flex items-center pt-2 pb-4">
              <input type="checkbox" id="풀무원" name="풀무원" defaultValue="풀무원" className="appearance-none peer" />
              <label
                htmlFor="풀무원"
            ...
            <li className="flex items-center pt-2 pb-4">
              <input type="checkbox" id="투다리" name="투다리" defaultValue="투다리" className="appearance-none peer" />
              <label
                htmlFor="투다리"
                className="w-6 h-6 mr-2 bg-input__button bg-check--no peer-checked:bg-check--yes"
              />
        ...
        <details className="border-b border-gray-100 group" open>
          ...
          <ul className="pl-1 text-[14px]">
            <li className="flex items-center pt-2 pb-4">
              <input type="checkbox" id="pet" name="pet" className="appearance-none peer" defaultValue="반려동물" />
              <label htmlFor="pet" className="w-6 h-6 mr-2 bg-input__button bg-check--no peer-checked:bg-check--yes" />
